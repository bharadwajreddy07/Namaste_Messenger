# ChatApp Architecture Documentation

## Overview
This ChatApp is a real-time messaging application built with React.js frontend and Node.js backend, featuring both HTTP REST APIs and WebSocket connections for real-time communication.
